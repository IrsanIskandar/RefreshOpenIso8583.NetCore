    ...
    public class Iso8583 : AMessage
    {
        ...
        protected static Template GetDefaultIso8583Template()
        {
            var template = new Template
                {
                    { Bit._002_PAN, FieldDescriptor.AsciiVar(2, 26, FieldValidators.N) },
                    ...
                    { Bit._031_SETTLEMENT_PROC_FEE_AMOUNT, FieldDescriptor.AsciiFixed(9, FieldValidators.Rev87AmountValidator) },
                    { Bit._032_ACQUIRING_INST_ID_CODE, FieldDescriptor.AsciiVar(2, 37, FieldValidators.N) },
                    ...
                    { Bit._037_RETRIEVAL_REF_NUM, FieldDescriptor.AsciiAlphaNumeric(12) },
                    ...
                    { Bit._041_CARD_ACCEPTOR_TERMINAL_ID, FieldDescriptor.AsciiFixed(15, FieldValidators.Ans) },
                    ...
                    { Bit._061_RESERVED_PRIVATE_SERVICE_CODE, FieldDescriptor.AsciiVar(3, 999, FieldValidators.Ans) },
                    { Bit._062_RESERVED_PRIVATE_INVOICE_NUMBER, FieldDescriptor.AsciiVar(3, 999, FieldValidators.Ans) },
                    { Bit._063_RESERVED_PRIVATE, FieldDescriptor.AsciiVar(3, 999, FieldValidators.Ans) },
                    { Bit._064_MAC, FieldDescriptor.BinaryVar(3, 64, FieldValidators.N) },
        ...
        public class Bit
        {
            ...
            /// <summary>
            ///   Reserved private (Ex: CVV2/Service Code)
            /// </summary>
            public const int _061_RESERVED_PRIVATE_SERVICE_CODE = 61;

            /// <summary>
            ///   Reserved private (Invoice Number, TPK Key)
            /// </summary>
            public const int _062_RESERVED_PRIVATE_INVOICE_NUMBER = 62;

            /// <summary>
            ///   Reserved private
            /// </summary>
            public const int _063_RESERVED_PRIVATE = 63;
